 ...
 */
public class SogouDemo extends DeepCrawler {

    public SogouDemo(String crawlPath) {
        super(crawlPath);
    }
    ...
    public Links visitAndGetNextLinks(Page page) {
        ...
        if (Pattern.matches("http://www.sogou.com/web\\?query=.*", url)) {
            ...
            */
            ...
            try {
                FileUtils.writeFileWithParent("/Users/copy202/test/"+id.incrementAndGet()+".html", content);
    ...
    public static void main(String[] args) throws Exception{
        SogouDemo crawler = new SogouDemo("/Users/copy202/test");
